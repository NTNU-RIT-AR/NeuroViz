...
export type ExperimentResult = ({ experiment_type: "rating" } & RatingExperimentResult) | ({ experiment_type: "choice" } & ChoiceExperimentResult)
...
export type ResultWithExperiment = { experiment_key: string; result: ExperimentResult }
